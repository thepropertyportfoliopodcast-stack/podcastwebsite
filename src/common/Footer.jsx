        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10">
               ...
               <ul className="flex items-center gap-[15px]">
                ...
                <li>
                  <a href="https://open.spotify.com/show/7BWrKVuUSeX1Qat3VEjUaU" target="_blank" rel="noopener noreferrer" aria-label="Listen to The Property Portfolio Podcast on Spotify">
                    <img width="28" height="22" className="min-w-[28px]" src="/spotify.svg" alt="" aria-hidden="true" />
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className=" border-t  border-t-[#FFFFFF33] sm:border-t-[0] pt-[20px] sm:pt-[0px]">
            ...
            <ul className="space-y-4 text-white text-[16px] font-[600]">
              <li>
                <Link href="/about" className="inline-flex min-h-[32px] items-center">About</Link>
              </li>
              <li>
                <Link href="/episode" className="inline-flex min-h-[32px] items-center">Episodes</Link>
              </li>
              {/* <li><Link href="#">E-guides</Link></li> */}
              <li>
                <Link href="/contact" className="inline-flex min-h-[32px] items-center">Contact</Link>
              </li>
            </ul>
          </div>
          ...
          <div className=" border-t  border-t-[#FFFFFF33] lg:border-t-[0] pt-[20px] lg:pt-[0px]">
            ...
            <ul className="space-y-4 text-white text-[16px] font-[600]">
              ...
              <li>
                <Link href="/access" className="inline-flex min-h-[32px] items-center">Terms Of Access</Link>
              </li>
              <li>
                <Link href="/use" className="inline-flex min-h-[32px] items-center">Terms Of Use</Link>
              </li>
              <li>
                <Link href="/privacy" className="inline-flex min-h-[32px] items-center">Privacy Policy</Link>
              </li>
            </ul>
          </div>
