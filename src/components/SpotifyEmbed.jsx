...
export default function SpotifyEmbed({ url, title }) {
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-white/15 bg-[#111] p-4 sm:p-5 md:p-6">
      ...
      <iframe title={`Listen to ${title || "this episode"} on Spotify`} src={src} width="100%" height="352" className="block w-full rounded-xl border-0" loading="lazy" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" />
    </section>
  );
}
