...
export default function Mission() {
  ...
  return (
    <section className="">
      <div className="relative z-[2] h-full rounded-[28px] border border-white/15 bg-white/[.035] p-6 shadow-xl backdrop-blur transition hover:-translate-y-1 hover:border-[#FC18D8]/70 md:min-h-[400px] md:p-9">
