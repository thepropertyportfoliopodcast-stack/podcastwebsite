              ...
              <div>
                ...
                <div className="flex items-center justify-center gap-[5px] md:gap-[15px] border border-[#A7A7A7] p-[10px] md:p-[15px] rounded-[15px] max-w-[280px]">
                  ...
                  >
                    ...
                    >
                      <g clipPath="url(#clip0_2186_1217)">
                        <path
                  ...
                  >
                    <svg aria-hidden="true" focusable="false"
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clipPath="url(#clip0_2186_1220)">
                        <path
                  ...
                  >
                    <svg aria-hidden="true" focusable="false"
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clipPath="url(#clip0_2186_1225)">
                        <path
                  ...
                  >
                    <svg aria-hidden="true" focusable="false"
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clipPath="url(#clip0_2186_1228)">
                        <path
                ...
                <div className="relative">
                  <div className="absolute top-[16px] left-[15px] min-w-[17px]">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g opacity="0.6">
                      <path d="M13.3346 12.3333C13.3346 13.3529 11.0489 14 8.0013 14C4.95368 14 2.66797 13.3529 2.66797 12.3333C2.66797 10.8462 5.33464 10 8.0013 10C10.668 10 13.3346 11 13.3346 12.3333Z" stroke="white" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M8 8C9.65686 8 11 6.65685 11 5C11 3.34315 9.65686 2 8 2C6.34315 2 5 3.34315 5 5C5 6.65685 6.34315 8 8 8Z" stroke="white" strokeLinecap="round" strokeLinejoin="round"/>
                      </g>
                    </svg>
                  </div>
