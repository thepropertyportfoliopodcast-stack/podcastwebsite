...
function HeroSection() {
  return (
    <section className="theme-hero relative mt-[70px] flex min-h-[600px] items-center justify-center pt-[20px] md:mt-[80px] xl:h-[680px] xl:min-h-[680px] xl:items-start xl:pt-[110px]">
